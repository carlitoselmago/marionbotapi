...
def get_data():
  return loadData("data/marion/fb.txt")

# Learning information
batch_size = 1#100
epochs = 24
latent_dim = 256
num_samples = 1028#4096
...
for i,line in enumerate(lines[: min(num_samples, len(lines) - 1)]):
  ...
  #target_text = input_text # temporary
  if (i % 2) == 0:
      input_texts.append(line)
  else:
      target_texts.append(line)
  # Use "\t" character as the starting character and "\n" character as the ending character.
