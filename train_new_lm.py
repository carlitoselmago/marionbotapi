...
train_file = f"data/marion/chatDB.txt"
test_file = f"data/marion/entretiens.txt"

model = LanguageModelingModel("gpt2", None, args=train_args, train_files=train_file,use_cuda=False)
